...
function kalium_header_custom_styling_filter() {
	if ( is_singular() ) {
		...
		$page_header_styling = get_field( 'page_header_styling', $post_id );

		if ( 'yes' === $page_header_styling ) {
			$header_background_color = get_field( 'header_background_color', $post_id );
			$header_bottom_border    = get_field( 'header_bottom_border', $post_id );
			$header_bottom_spacing   = get_field( 'header_bottom_spacing', $post_id );
