...
class Kalium_Theme_Plugins {
	...
	public function setSourceForBundledPlugins( $return, $package, $upgrader ) {
		...
		// Installing plugin
			...
			return new WP_Error( 'download_failed', $skin->upgrader->strings['download_failed'], 'Theme must be registered in order to install or update premium bundled plugins. Navigate to Laborator &raquo; Product Registration to register your theme.' );
		}
		// Update page
